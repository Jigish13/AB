...
public class ForgetPasswordTokenActivity extends AppCompatActivity {

    EditText et_token;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_forget_password_token);
    ...
    public void onSubmitToken()
    {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(ForgetPasswordTokenActivity.this);
...
*/
                        ...
                        Toast.makeText(ForgetPasswordTokenActivity.this, "No response available.", Toast.LENGTH_SHORT).show();

                        Log.d("Error", "No response available");
                    }
                } catch (Exception e) {
                    Toast.makeText(ForgetPasswordTokenActivity.this, "Error occurred.", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<Map<String, Object>> call, Throwable t) {
                ...
                Toast.makeText(ForgetPasswordTokenActivity.this, "Failed", Toast.LENGTH_SHORT).show();
