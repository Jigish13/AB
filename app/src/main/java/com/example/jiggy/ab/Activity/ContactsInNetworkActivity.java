...
import com.example.jiggy.ab.Adapter.ContactsInNetworkAdapter;
                ...
                try {
                    ...
                    if (response != null && response.body() != null) {
                        ...
                        for (int i = 0, m = facultyListArr.size(); i < m; i++) {
                            userId = facultyListArr.get(i).getAsJsonArray().get(0).getAsInt();
                            Log.d("error", "ID: " + userId);

                            firstName = facultyListArr.get(i).getAsJsonArray().get(1).getAsString();
                            Log.d("error", "FN: " + firstName);

                            lastName = facultyListArr.get(i).getAsJsonArray().get(2).getAsString();
                            Log.d("error", "LN: " + lastName);


                            if (facultyListArr.get(i).getAsJsonArray().get(3).isJsonNull())
                                profilePic = null;

                            else {
                                profilePic = facultyListArr.get(i).getAsJsonArray().get(3).getAsString();
                            }
                        ...
                        for (int i = facultyListArr.size(), m = studentListArr.size(); i < m; i++) {
                            userId = studentListArr.get(i).getAsJsonArray().get(0).getAsInt();
                            Log.d("error", "ID: " + userId);

                            firstName = studentListArr.get(i).getAsJsonArray().get(1).getAsString();
                            Log.d("error", "FN: " + firstName);

                            lastName = studentListArr.get(i).getAsJsonArray().get(2).getAsString();
                            Log.d("error", "LN: " + lastName);
                            if (studentListArr.get(i).getAsJsonArray().get(3).isJsonNull())
                                profilePic = null;

                            else {
                                profilePic = studentListArr.get(i).getAsJsonArray().get(3).getAsString();
                            }
